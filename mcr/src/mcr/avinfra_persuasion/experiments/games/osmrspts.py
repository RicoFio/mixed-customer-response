...
@dataclass
class OSMRSPTSGame(FiniteDifferenceAdamMixin, StateDependentMaskGameBase, EnumerationMixin):
    """
    One sender, multiple receivers, state-dependent policy, typed (private) signal.
    ...
    _signal_policy_error = (
        "OSMRGame currently requires a StateDependentMaskSignalPolicy sender."
    )
